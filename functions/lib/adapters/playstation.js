...
exports.fetchPlaystationNews = fetchPlaystationNews;
const rss_1 = require("../utils/rss");
const config_1 = require("../config");
const summary_1 = require("../utils/summary");
const parser_1 = require("../utils/parser");
async function fetchPlaystationNews() {
    const items = await (0, rss_1.fetchRSSFeed)(config_1.CONFIG.FEEDS.PLAYSTATION, 'PlayStation Blog');
    const results = [];
    for (const item of items.slice(0, 10)) {
        const rawTitle = item.title || 'PlayStation Blog';
        ...
        results.push({
            ...
            author: item.creator || item.author || 'PlayStation Team',
            publishedAt: pubDate,
